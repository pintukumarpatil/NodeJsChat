...
public class FriendsAdapter extends RecyclerView.Adapter<FriendsAdapter.CustomViewHolder> {
    ...
    public FriendsAdapter(Context context, ArrayList<GroupDTO> list, OnItemClickListener.OnItemClickCallback onItemClickCallback) {
        super();
        this.list = list;
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int position) {
        ...
        customViewHolder.setGroupName(dto.getUserName());
